        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 max-w-4xl mx-auto divide-y divide-brand-stem/15 md:divide-y-0 md:divide-x">
            ...
            <div className="text-center px-4 py-6 md:py-2">
              ...
              <div className="text-xl font-light text-brand-forest font-serif leading-tight">
                {room.priceFrom.split(' / ').map((part, i) => {
                  const [price, label] = part.split(' ');
                  return (
                    <span key={i}>
                      {i > 0 && <span className="text-[#888] text-sm"> / </span>}
                      {price} <span className="text-[#888] text-sm lowercase">{label}</span>
                    </span>
                  );
                })}
              </div>
