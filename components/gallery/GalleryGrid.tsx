...
const galleryImages: GalleryImage[] = [
  ...
  { src: '/images/Ilala-Lodge-Facilities-Pools-02.jpg', alt: 'Swimming Pool', category: 'pool' },
  ...
  { src: '/images/Ilala-Lodge-Facilities-Pools-24.jpg', alt: 'Swimming Pool', category: 'pool' },
